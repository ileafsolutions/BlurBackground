...
public class BlurUtil {
    ...
    * */
    ...
    public BlurUtil load(Bitmap bitmap) {
        this.image = bitmap;
        return this;
    }

    public BlurUtil load(int res) {
        image = BitmapFactory.decodeResource(context.getResources(), res);
        return this;
    }

    public BlurUtil intensity(float intensity) {
    ...
    public BlurUtil Async(boolean async) {
        this.async = async;
        return this;
    }
